package com.demo.track.config;

import com.demo.track.handler.RunTimeHandler;
import com.demo.track.model.KoTimeConfig;
import com.demo.track.util.Context;
...
public class DefaultConfig {
    ...
    @Value("${koTime.pointcut:execution(* com.demo.track..*.*(..))}")
...
//        advisor.setExpression(pointcut + " && !execution(* com.demo.track..*.*(..))");
